const GnairaContractAddress = "0x9a07E5F7917bFd37d2Bd92BC9b241E4429d515bC";
const GnairaABI = [
	{
		"inputs": [
			{
	...
	},
	{
		"inputs": [
			{
				"internalType": "enum Gnaira.ProposalType",
				"name": "proposalType",
				"type": "uint8"
			},
			{
      ...
      contract = new ethers.Contract(
        ...
        signer
              ...
              async function blacklistAddress() {
                  ...
                  const accounts = await web3.eth.getAccounts();
                  await contract.methods.blacklist(address).send({ from: accounts[0] });
              }

              async function unblacklistAddress() {
                  const address = document.getElementById("unblacklistAddress").value;
                  const accounts = await web3.eth.getAccounts();
                  await contract.methods.unblacklist(address).send({ from: accounts[0] });
              }